...
* Return an empty HTTP 200 for Git credential requests with an omitted or empty repository path, allowing Git to try another helper without resolving a profile or vending a token.
