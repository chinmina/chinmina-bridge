...
// ConstructRepositoryURL reconstructs a credential URL. Git may omit path for
// host-wide credentials; callers must decline those when repository scope is required.
