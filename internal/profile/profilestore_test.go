...
func TestNewProfileStoreOf_OrganizationProfile(t *testing.T) {
	...
	store := profile.NewProfileStoreOf[profile.OrganizationProfileAttr](profiles, invalidProfiles)
...
func TestNewProfileStoreOf_PipelineProfile(t *testing.T) {
	...
	store := profile.NewProfileStoreOf[profile.PipelineProfileAttr](profiles, invalidProfiles)
...
func TestProfileStoreOf_Get_Success(t *testing.T) {
	...
	store := profile.NewProfileStoreOf[profile.OrganizationProfileAttr](profiles, map[string]error{})
...
func TestNewProfiles(t *testing.T) {
	orgProfiles := profile.NewProfileStoreOf[profile.OrganizationProfileAttr](
		map[string]profile.AuthorizedProfile[profile.OrganizationProfileAttr]{},
		map[string]error{},
	)
